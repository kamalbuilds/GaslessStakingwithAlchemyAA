...
contract LightAccountTest is Test {
    ...
    function testReturnsAddressWhenAccountAlreadyExists() public {
        AdvancedLightAccount account = factory.createAccount(OWNER_ADDRESS, 1);
        AdvancedLightAccount otherAccount = factory.createAccount(OWNER_ADDRESS, 1);
    ...
    function testGetAddress() public {
        ...
        AdvancedLightAccount factual = factory.createAccount(OWNER_ADDRESS, 1);
